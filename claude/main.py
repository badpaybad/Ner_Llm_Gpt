...
pipe = pipeline("text-generation", model="/work/llama-2-7b-claude-chat")

# Load model directly
from transformers import AutoTokenizer, AutoModelForCausalLM

tokenizer = AutoTokenizer.from_pretrained("/work/llama-2-7b-claude-chat")
model = AutoModelForCausalLM.from_pretrained("/work/llama-2-7b-claude-chat")
